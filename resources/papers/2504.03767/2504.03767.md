...
to-end RADE attack for CT using Claude Desktop.
In it, an attacker has corrupted a
...
McpSafetyScanner - Multi-Agentic Framework for Proactive MCP
...
AttackerPublic filesMCP userSearch my files for X, use MCP servers for search resultsXYZPreprint. Under review.
...
Tools = {          MCP Server tools } Role = “Hacker” Goals = {“Probe system using tools and server resources”,“Return discovered vulnerabilities”,} Tools = {     Web,      ArXiv,                } Role = “Auditor” Goals = {“for each (tool, prompt, resource, vulnerability):-Find related vulnerabilities”,“Find/determine remediations for alllearned vulnerabilities”,} HackerNewsTools = {        Hacker,        Auditor} Role = “Supervisor” Goals = {“Monitor other agents,keep them on task”,“Produce a detailedsecurity report”,} Stage 1 – MCP server vulnerability detectionStage 2 – Detect related vulnerabilities, determine remediationsStage 3 – Generate a detailed security report of vulnerabilities and remediationsPreprint. Under review.
...
//github.com/modelcontextprotocol/servers/tree/main/src/everything”, 2025b. ”Ac-
cessed: 2025-03-26”.
...
Introducing the Model Context Protocol. ”https://www.anthropic.com/news/
...
Why Anthropic’s Model Context Protocol

tion Of AI Agents.
why-anthropics-model-context-protocol-is-a-big-step-in-the-evolution-of-ai-agents/”,
2025. ”Accessed: 2025-02-12”.

Is A Big Step In The Evolu-
”https://www.forbes.com/sites/janakirammsv/2024/11/30/
...
OpenAI. OpenAI Agents SDK - Model context protocol.
...
(a) Publicly available file with seemingly helpful MCP content. In actuality, the content grants a bad
...
D Llama-3.3-70B-Instruct refusals involve explicit harmful/unsafe
